...
export class HomeFiveComponent {
  ...
  private loadServicesTranslation(): void {
    this.translate.get('leftServices').subscribe((data: any[]) => {
      this.leftServices = data;
    });
    this.translate.get('rightServices').subscribe((data: []) => {
      this.rightServices = data;
    });
  }
  ...
  //     desc: 'Learn from professional, friendly, and patient instructors. All instructors are fully licensed and trained in modern teaching methods',
  //   },
  //   {
  //     title: 'Flexible Scheduling',
  //     desc: 'Choose lesson times that work for you, including evenings and weekends.',
  //   },
  //   {
  //     title: 'Well-Maintained Vehicles',
  //     desc: 'Drive in modern, dual-control cars for maximum safety. Regularly serviced and equipped with the latest features for a smooth experience.',
  //   },
  // ];

  // rightServices = [
  //   {
  //     titleKey: 'rightServices.highPassRate.title',
  //     descKey: 'rightServices.highPassRate.desc',
  //   },
  //   {
  //     titleKey: 'rightServices.theoryTraining.title',
  //     descKey: 'rightServices.theoryTraining.desc',
  //   },
  //   {
  //     titleKey: 'rightServices.affordablePricing.title',
  //     descKey: 'rightServices.affordablePricing.desc',
  //   },
  // ];
  // Portfolio
  // portfolios = [
  ...
  pricing = [
    {
      title: 'Տեասական փաթեթ',
      subTitle: 'Վարորդական իրավունքի տեսական քննության պատրաստում',
      // currency: 'դ',
      // amount: 70000,
      btnClass: 'btn btn-dark btn-md btn-default btn-square',
      btnText: 'Get Started',
      features: [
        'ՃԵԿ և ՃԵԱԱՄ ՀՀ օրենք',
        '15 դասաժամ',
        '1 ամիս',
        'Դասի օրեր՝ երկուշաբթիից շաբաթ',
      ],
    },

    {
      title: 'գործնական փաթեթ',
      subTitle: 'Վարորդական իրավունքի գործնական քննության պատրաստում',
      // currency: '$',
      // amount: 16.99,
      btnClass: 'btn btn-dark btn-md btn-default btn-square',
      btnText: 'Get Started',
      features: [
        '11 քննական վարժություն, վարման դասեր քննական երթուղիով, քննության փորձնական հանձնում',
        'գործնական դաս՝ 10 դասաժամ',
        'դասաժամի տևողություն՝ 1 ժամ',
        'դասի տեղանքն ու գրաֆիկը՝ ճկուն',
        'կուրսի տևողությունը՝ 1 ամիս',
      ],
    },
  ...
  //     title: 'David Levine',
  //     description:
  //       'Very much satisfied with the service. Delivered on time and responded to request for modifications within few hours. I recommend Sloganshub for anyone looking for smart business.',
  //   },
  ...
  //     title: 'Anne McAdams',
  //     description:
  //       'Lorem ipsum dolor sit amet, consectetur adipiscing elit. Donec sodales nec nulla ac aliquet. Duis vel nunc eget.',
  //   },
  // ];
